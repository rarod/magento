...
return [
    'modules' => [
        ...
        'JRComercio_AddCustomerFields' => 1,
        'JRComercio_AddErpCategoryIdField' => 1,
        'JRComercio_AddErpProductIdField' => 1,
        'JRComercio_AddProductFields' => 1,
        'JRComercio_CompanyInformation' => 1,
        'JRComercio_GuestCustomer' => 0,
        'JRComercio_MagentoCatalog' => 1,
        'JRComercio_MagentoSales' => 1,
        'JRComercio_PaymentMethods' => 0,
        'JRComercio_SortStreetFields' => 1,
        'Klarna_Core' => 1,
